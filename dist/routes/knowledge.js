...
const controllerKnowledge = __importStar(require("../controllers/knowledge"));
const middlewareAuth = __importStar(require("../middlewares/auth"));
const upload_1 = __importDefault(require("../middlewares/upload"));
const router = (0, express_1.Router)();
router.post('/', middlewareAuth.jwt, middlewareAuth.admin, upload_1.default, controllerKnowledge.create);
router.patch('/:id', middlewareAuth.jwt, middlewareAuth.admin, upload_1.default, controllerKnowledge.update);
