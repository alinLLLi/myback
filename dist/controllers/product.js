...
exports.remove = exports.getId = exports.get = exports.getAll = exports.update = exports.create = void 0;
...
const remove = async (req, res) => {
    ...
    const parsedParams = await paramsSchema.validate(req.params, { stripUnknown: true });
    const result = await product_1.default.findByIdAndDelete(parsedParams.id).orFail(new Error('PRODUCT NOT FOUND'));
    if (result.image) {
        await cloudinary_1.default.uploader.destroy(result.image);
    }
    res.status(http_status_codes_1.StatusCodes.OK).json({
