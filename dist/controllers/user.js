...
exports.updateProfile = exports.getProfile = exports.getCart = exports.cart = void 0;
...
const updateProfile = async (req, res) => {
    const schema = yup.object({
        account: yup
            ...
            .test('isAlphanumeric', '帳號只能是英數字', (value) => !value || validator_1.default.isAlphanumeric(value)),
        password: yup
            .string()
            .typeError('資料格式錯誤')
            .min(4, '密碼最少 4 個字')
